class AuthGenerator < Rails::Generator::Base
  ...
  def manifest
    record do |m|
      ...
      m.template("views/user_mailer/forgot_password.text.html.erb", "app/views/user_mailer/forgot_password.text.html.erb")
      m.template('views/user_mailer/verify_email.text.html.erb', 'app/views/user_mailer/verify_email.text.html.erb')
